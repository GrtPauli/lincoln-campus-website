export const FACULTIES = [
  {
    title: "FACULTY OF MEDICINE AND ALLIED HEALTH SCIENCES",
    slug: "faculty-of-medicine-and-allied-health-sciences",
    image:
    ...
    facultyMembers: [
      ...
      },
      {
        ...
        position:
          "Pro-Dean (Clinical) Professor of Surgery, School of Medicine",
        image:
    ...
    galleryImages: [
      {
        id: 1,
        src: "https://plus.unsplash.com/premium_photo-1661663078197-13ef87b6f5ff?w=500",
        alt: "Sample image 1",
      },
      {
        id: 2,
        src: "https://plus.unsplash.com/premium_photo-1681843039768-0e22b7a031d5?w=500",
        alt: "Sample image 2",
      },
    ],
    testimonials: [
  ...
  },
  {
    ...
    dean: {
      ...
      name: "Prof. Dr Laura Chen",
      title: "Dean, Faculty of Sciences and Computing",
      school: "Lincoln University College",
      heading: "Message By The Dean",
      message: [
        "Welcome to the Faculty of Sciences and Computing!",
        "Our faculty integrates innovation and scientific rigor to prepare students for the challenges of tomorrow.",
        "From life sciences to data science, we emphasize applied learning and impactful research.",
      ],
    },
    facultyMembers: [
      {
      ...
      {
        name: "Dr. Anita Rao",
        position: "Senior Lecturer, Physics",
    ...
    galleryImages: [
      ...
      {
        id: 2,
        src: "https://images.unsplash.com/photo-1535223289827-42f1e9919769?w=500",
        alt: "Science lab",
      },
    ],
    testimonials: [
      {
        id: 1,
        name: "Kevin Lee",
        role: "B.Sc. Cyber Security, Year 4",
        image: "https://randomuser.me/api/portraits/men/33.jpg",
        text1:
          "The computing labs are world-class, and I’ve gained hands-on experience in AI and data science.",
        text2:
          "This faculty has pushed me to think outside the box and apply science to real-world challenges.",
      },
    ],
  },
  {
    ...
    dean: {
      ...
      heading: "Message By The Dean",
      message: [
        "Welcome to the Faculty of Management and Social Sciences!",
        "We aim to build leaders who understand both business and society.",
        "Our graduates are innovators, problem solvers, and change-makers.",
      ],
    },
    facultyMembers: [
      {
    ...
    galleryImages: [
      {
        id: 1,
        src: "https://images.unsplash.com/photo-1556761175-4b46a572b786?w=500",
        alt: "Business school",
      },
      {
        id: 2,
    ...
    testimonials: [
      {
        id: 1,
        name: "Maria Gonzalez",
        role: "B.Sc. Business Administration, Year 3",
        image: "https://randomuser.me/api/portraits/women/44.jpg",
        text1:
          "Studying business here has given me the confidence and skills to launch my own startup.",
        text2:
          "The lecturers encourage critical thinking and real-world application of social science theories.",
      },
    ],
  },
];
